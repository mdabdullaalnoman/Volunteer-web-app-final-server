...
client.connect(err => {
  const dataCollection = client.db("Volunteer-Web-App").collection("volunteer");
  const eventsCollection = client.db("Volunteer-Web-App").collection("events");
  const addEventsCollection = client.db("Volunteer-Web-App").collection("addedEvents");
